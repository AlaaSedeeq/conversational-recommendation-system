...
def get_recommendations(collected_info: str) -> list[dict]:
    ...
    Args:
        collected_info (str): Concise summary of user preferences from follow-up stpes
    ...
    """
    template = """<provided_context>\n: Conversations (Use its content for recommendations, and mirror the response style): \n{conversations}"""
    try: 
